...
public class MuleConnector extends ProcessConnector
{
    ...
    private Boolean addProcessInstanceIdVariable=false;
    private Boolean addActivityInstanceIdVariable=false;
    private String asynchResponseVariableName=null;
    ...
    private Map getProperties()
    {
        ...
        if(addActivityInstanceIdVariable)
        {
        	map.put("MULE_BOS_ACTIVITY", getActivitytInstanceUUID().toString());
        }
        if(addProcessInstanceIdVariable)
        {
        	map.put("MULE_BPM_PROCESS_ID", getActivitytInstanceUUID().getProcessInstanceUUID().toString());
        }
        if(asynchResponseVariableName!=null && asynchResponseVariableName.length()>0)
        {
        	map.put("MULE_BOS_RESULT_VARIABLE", asynchResponseVariableName);
        }
        return map;
    }
	...
	public void setAddProcessInstanceIdVariable(Boolean addProcessInstanceIdVariable) {
		this.addProcessInstanceIdVariable = addProcessInstanceIdVariable;
	}

	public void setAddActivityInstanceIdVariable(
			Boolean addActivityInstanceIdVariable) {
		this.addActivityInstanceIdVariable = addActivityInstanceIdVariable;
	}

	public void setAsynchResponseVariableName(String asynchResponseVariableName) {
		this.asynchResponseVariableName = asynchResponseVariableName;
	}
